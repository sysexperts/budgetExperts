  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Ausgaben-Verlauf</h3>
          <p className="text-sm text-gray-500">Jede Änderung wird protokolliert</p>
        </div>
      ...
      <div className="relative">
        ...
        {/* Tooltip */}
        {hoveredPoint && (
          <div className="absolute top-2 right-2 bg-white border border-gray-200 rounded-lg p-3 shadow-lg z-10">
      ...
      <div className="mt-6 grid grid-cols-3 gap-4">
        <div className="text-center">
          <p className="text-sm text-gray-500 mb-1">Aktueller Betrag</p>
          <p className="text-lg font-semibold text-gray-900">€{currentTotal.toFixed(2)}</p>
        </div>
        <div className="text-center">
          <p className="text-sm text-gray-500 mb-1">Budget-Limit</p>
          <p className="text-lg font-semibold text-maxcrowds-green">€{budgetLimit.toFixed(2)}</p>
        </div>
        <div className="text-center">
          <p className="text-sm text-gray-500 mb-1">Änderungen</p>
          <p className="text-lg font-semibold text-blue-600">{filteredHistory.length}</p>
        </div>
      </div>
    </div>
  )
